...
func SetupRoutes(apiBasePath string) {
	...
	http.Handle(fmt.Sprintf("%s/%s", apiBasePath, productsPath), cors.MiddleWareHandler(productsHandler))
	http.Handle(fmt.Sprintf("%s/%s/", apiBasePath, productsPath), cors.MiddleWareHandler(productHandler))
}
